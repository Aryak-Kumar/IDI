...
<form align="center" action="upload.php" method="post" enctype="multipart/form-data">
  ...
  <input type="text" name="name" id="name" placeholder="Enter Caption...">
...
<center>
  ...
  <input class="form-control" id="myInput" type="text" placeholder="Search Image Info" style="width:60%;border: 2px solid red;">
  </form>
...
<th class='bg-info text-light'><center>Caption</center>
<th  class='bg-info text-light'><center>Image</center>
...
while($row = mysqli_fetch_array($result))
{
    ...
    echo "<td>$row[1] </td>";
    echo "<td>$row[2] </td>";
    echo "<td><div class='col'><img src='Image/".$row[1]."' height='200px' width='auto'></div></td>";
    echo "<td> <a href='del_img.php?id=$row[0]'><button class='btn btn-danger' >delete</button></a></td>";
    echo "</tr>";
