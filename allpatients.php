...
<?php include "header.php";?>
  ...
  <input class="form-control" id="myInput" type="text" placeholder="Search Patient Info" style="width:60%;border: 2px solid red;">
  </form>
...
while($row = mysqli_fetch_array($result))
{
	...
	echo "<td>$row[5] </td>";
	echo "<td>$row[6] </td>";
	echo "<td> <a href='del_student.php?id=$row[0]'><button class='btn btn-danger' >delete</button</a></td>";
	echo "</tr>";
