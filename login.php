...
<center><input  type='text' Required placeholder='Username' name="username"></center>
<br>
<center><input type='password' Required placeholder='password' id="pass"name="password"></center>
<br>
<center><input type="checkbox" onclick="myFunction()">  Show Password</center>
<br>
      </div>
      <center><input type="Submit" class="btn btn-primary" value="login"></div></form></center>
